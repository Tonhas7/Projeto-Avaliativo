...
def gerar_relatorio(caminho_arquivo):
    ...
    c.drawString(3.5 * inch, height - 1.5 * inch, "Nascimento")
    c.drawString(5 * inch, height - 1.5 * inch, "Cpf")
    c.drawString(6.5 * inch, height - 1.5 * inch, "Gênero")
    c.drawString(7.5 * inch, height - 1.5 * inch, "Cidade")
...
if __name__ == "__main__":
    gerar_relatorio("relatorio_clientes.pdf")
